    ...
    return <div className="min-w-screen min-h-screen bg-login flex items-center justify-center">
        <div className="flex justify-center items-center w-10/12 gap-36">
            <div className="flex flex-col gap-6 self-start">
                ...
                <p>Website ini diperuntukkan untuk pelaporan adanya masalah dalam masyarakat seperti kekerasan rumah tangga, penganiayaan, dan lain lain.</p>
            ...
            <img src="/images/homeImage.png" width={200} className="w-1/3 md:block hidden" alt="" />
        </div>
    </div>
}
