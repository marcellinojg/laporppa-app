        ...
        <div className="flex justify-center items-center w-10/12 gap-36">
            <div className="flex flex-col gap-6 self-start">
                <div className="flex gap-8 items-center mt-10">
                    <img src="/new-petra/images/logo-pemkot-new.png" className="w-16" alt="Logo Pemkot Surabaya" />
                    <img src="/new-petra/images/logo-without-text.png" className="w-24" alt="Logo SIAPPPAK" />
                </div>
            ...
            <img src="/new-petra/images/homeImage.png" width={200} className="w-5/12 md:block hidden" alt="Ilustrasi gambar home" />
        </div>
    </div>
}
