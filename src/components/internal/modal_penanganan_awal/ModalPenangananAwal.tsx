...
import modalPenangananAwalMapper from "../../../helpers/modalPenangananAwalMapper";

interface ModalPenangananAwalProps {
...
export default ModalPenangananAwal;